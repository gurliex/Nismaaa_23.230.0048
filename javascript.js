...
var finalScoreTeori = (parseInt(presensiTeori) * 0.1) + (parseInt(tugasTeori) * 0.3) + (parseInt(utsTeori) * 0.3) + (parseInt(uasTeori) * 0.3);
var finalScorePraktik = (parseInt(presensiPraktik) * 0.1) + (parseInt(tugasPraktik) * 0.3) + (parseInt(utsPraktik) * 0.3) + (parseInt(uasPraktik) * 0.3);
...
const nilaiAkhirPraktik = (presensiPraktik * 0.3) + (tugasPraktik * 0.3) + (utsPraktik * 0.3) + (uasPraktik * 0.3);
